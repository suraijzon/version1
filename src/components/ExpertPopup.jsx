...
const sliderBackground = `linear-gradient(
    to right,     #000 0%,     #000 ${percentage}%,     #ddd ${percentage}%,     #ddd 100%
  )`;
    ...
    <div className="popup-left">
      ...
      <div className="popup-left-top">
        ...
        <div className="popup-review">
          ...
          <strong>ZonzoTech</strong>

          <p>
            "Excellent IT resource outsourcing service.
            They provided highly skilled developers who
    ...
    <div className="popup-right">
      ...
      >
        ...
        >
          ...
          <option value="Website Growth Audit">

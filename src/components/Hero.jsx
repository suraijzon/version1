      ...
      <div className="hero-inner">
        <div className="hero-copy">
          ...
          <div className="hero-sub">
            <p>
              Outdated website? No online visibility? Struggling to keep up with
              AI trends?
            </p>
          </div>
          ...
          <div className="hero-sub2">
            <p>
              In today’s digital-first world, a slow website, poor SEO, or
              missing automation can stall your growth. Businesses are losing
              leads and conversions due to poor design and unoptimized
              experiences.
            </p>
          </div>

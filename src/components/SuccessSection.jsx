  ...
  const projects = [
    {
      ...
      extra: [
        ...
        { text: "Bootstrap", background: "#ff7300" }
      ],
      img: item1
    },
    {
      ...
      extra: [
        ...
        { text: "Node.js", background: "#ff7300" }
      ],
      img: item2
    },
    {
      ...
      extra: [
        ...
        { text: "Next.js", background: "#ff7300" },
